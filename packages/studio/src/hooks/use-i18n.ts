...
const strings = {
  ...
  "import.wizardTab": { zh: "导入旧稿", en: "Import manuscript" },
  "import.wizardTitle": { zh: "导入已有作品", en: "Import existing work" },
  "import.wizardHint": { zh: "上传或粘贴已写好的章节，预览分章后一键创建书籍并生成设定，随后可继续写下一章。", en: "Upload or paste existing chapters, preview the split, create a book with reverse-engineered foundation, then continue writing." },
  "import.wizardDropHint": { zh: "点击或拖拽上传文稿", en: "Click or drop a manuscript file" },
  "import.wizardFileTypes": { zh: "支持 .txt / .md", en: "Supports .txt / .md" },
  "import.wizardOrPaste": { zh: "或直接粘贴正文", en: "Or paste the full text" },
  "import.wizardPreview": { zh: "预览分章", en: "Preview chapters" },
  "import.wizardBack": { zh: "返回", en: "Back" },
  "import.wizardContinue": { zh: "下一步", en: "Continue" },
  "import.wizardCreateNew": { zh: "创建新书", en: "Create new book" },
  "import.wizardUseExisting": { zh: "导入到已有书", en: "Import into existing book" },
  "import.wizardBookTitle": { zh: "书名", en: "Book title" },
  "import.wizardTargetChapters": { zh: "目标章数", en: "Target chapters" },
  "import.wizardChapterWords": { zh: "每章字数", en: "Words per chapter" },
  "import.wizardBlurb": { zh: "简介 / 备注（可选）", en: "Blurb / notes (optional)" },
  "import.wizardResumeFrom": { zh: "从第 N 章续导（已有章节时）", en: "Resume from chapter N" },
  "import.wizardMode": { zh: "导入模式", en: "Import mode" },
  "import.wizardModeContinuation": { zh: "续写本书", en: "Continue this story" },
  "import.wizardModeContinuationHint": { zh: "把文稿当作同一本书的已有正文，后续接着写。", en: "Treat the text as prior chapters of the same book." },
  "import.wizardModeSeries": { zh: "同世界观新系列", en: "Same universe, new series" },
  "import.wizardModeSeriesHint": { zh: "继承世界设定，但作为独立新故事处理。", en: "Share the universe while starting an independent story." },
  "import.wizardStart": { zh: "开始导入", en: "Start import" },
  "import.wizardImportingHint": { zh: "正在分章写入并逆向生成设定，可能需要几分钟…", en: "Writing chapters and reverse-engineering foundation — this may take a few minutes…" },
  "import.wizardDoneTitle": { zh: "导入完成", en: "Import complete" },
  "import.wizardOpenBook": { zh: "打开书籍", en: "Open book" },
  "import.wizardContinueWriting": { zh: "继续写下一章", en: "Continue writing" },
  "import.wizardAgain": { zh: "再导一本", en: "Import another" },
  "import.legacyChaptersHint": { zh: "旧版快捷导入：需要先有目标书。推荐使用「导入旧稿」向导。", en: "Legacy quick import: target book required. Prefer the Import manuscript wizard." },
  "import.chapters": { zh: "快捷粘贴", en: "Quick paste" },
